...
const FormProprietariesFilter = () => {
  ...
  return (
    <FieldsetCard legend="Filtragem de proprietários" obrigatoryFields={false}>
      <div className="row">
        <FormInputText
          col={8}
          id="filter"
      ...
      <div className="row">
        ...
        <FormLinkButton
          ...
          label
          text="NOVO"
          link="/representacoes/gerenciar/proprietario/novo"
        />
      </div>
    </FieldsetCard>
  );
...
export default FormProprietariesFilter;
